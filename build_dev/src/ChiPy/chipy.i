 ...
 * entre SWIG et numpy */
%include "/home/pv/brg/code_fortran/compas_lmgc90/src/lmgc90_dev/src/tools/swig/numpy-2.2.6.i"
%init %{
import_array();
%}
...
/* exception handling */
%{
#include "/home/pv/brg/code_fortran/compas_lmgc90/src/lmgc90_dev/src/Core/contribs/exception.h"
%}
 ...
 */
%apply (double IN_ARRAY1[ANY]) {(double  vec3[3])};
%apply (double IN_ARRAY1[ANY]) {(double rvec3[3])};
%apply (double IN_ARRAY1[ANY]) {(double rvec6[6])};
...
%apply (double IN_ARRAY2[ANY][ANY]) {(double rmat33[3][3])};
...
%include "/home/pv/brg/code_fortran/compas_lmgc90/build_dev/src/ChiPy/docs/chipy_swig_docstrings.i"
