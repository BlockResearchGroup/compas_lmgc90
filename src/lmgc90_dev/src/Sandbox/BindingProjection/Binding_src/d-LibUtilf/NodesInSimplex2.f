...
C	  REM : ON PEUT AUSSI ECRASER VT DANS X
	  CALL IMPTDC ( 'NodesInSimplex2' , 3 , 'U' , U , IDIMAX , 
     &                  IDIMAX )
	  CALL IMPTDC ( 'NodesInSimplex2' , 3 , 'S' , S , 1 , IDIMAX )
	  CALL IMPTDC ( 'NodesInSimplex2' , 3 , 'VT' , VT , IDIMAX ,
     &                  IDIMAX )
	  IF (KERR .NE. 0) THEN
	    CALL IMPEC ( 'NodesInSimplex2' , 0 , 'KERR' , KERR )
...
C	    ALPHAP3 = UT * ALPHAP2
	    CALL dgemv ( 'T'     , IDIM , IDIM  , XPUN    , U    ,  
     &                   IDIMAX , ALPHAP2 , IPUN , XZERO , ALPHAP3 ,
     &                   IPUN )
	    CALL IMPTDC ( 'NodesInSimplex2' , 3 , 'U' , U , IDIMAX , 
     &                    IDIM )
...
CDD     &                 XZERO , ALPHAP(2,1) , NBD )
C	    ALPHAP2 = V * ALPHAP3
	    CALL dgemv ( 'T'     , IDIM , IDIM  , XPUN    , VT   , 
     &                   IDIMAX , ALPHAP3 , IPUN , XZERO , ALPHAP2 ,
     &                   IPUN )
	    CALL IMPTDC ( 'NodesInSimplex2',3,'ALPHAP2',ALPHAP2,1,IDIMAX )
C
