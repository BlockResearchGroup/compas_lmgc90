...
import numpy as np
from compas_lmgc90._lmgc90 import lmgc90_solve_numpy
from compas_lmgc90._lmgc90 import VectorNumpyArrayDouble, VectorNumpyArrayInt
...
vertices_arrays = VectorNumpyArrayDouble()
faces_arrays = VectorNumpyArrayInt()
