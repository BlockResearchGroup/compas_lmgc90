...
def generate():
    ...
    # mod & mat
    mot = pre.model(name='M2D_T',physics='MECAx',element='T3xxx',dimension=2, external_model='no___',
                    kinematic='small',material='elas_',anisotropy='iso__',mass_storage='coher')
    mods+=mot
    
    moq = pre.model(name='M2D_Q',physics='MECAx',element='Q4xxx',dimension=2, external_model='no___',
                    kinematic='small',material='elas_',anisotropy='iso__',mass_storage='coher')
    mods+=moq
