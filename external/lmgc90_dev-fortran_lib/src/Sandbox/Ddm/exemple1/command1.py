...
pas_temps = 0.005
max_iteration_step = 100 # nombre iteration
max_time_step = 200 # nombre pas de temps
...
def Mise_en_donnee(numerosdm,file1):
	...
	return chpoE,chmlE,mail1,nmail1,ListInt1,numer1,MSE,MapSdm1,ddlD1,UD1,ddlI1,DepiSdm,CE,bE,liste_neuds_total,ListMeshInt
...
def EtapeDD3_mise_en_donnee_du_sdm(myrank,file1):
	chpoE,chmlE,mail1,nmail1,ListInt1,numer1,MSE,MapSdm1,ddlD1,UD1,ddlI1,DepiSdm,CE,bE,liste_neuds_total,ListMeshInt = Mise_en_donnee(myrank,file1)
	...
	for i23 in r_[0:len(ListMeshInt)]:
		...
		l1= hstack([l1,l2]).astype(int)
		#print 'l1',l1
		#print 'liste',liste 
		liste_complementaire = setdiff1d(liste, l1) #element du sous domaine pas dans linterface
		#print 'liste_complementaire' ,liste_complementaire
		liste_noeud_interface_sdm = setdiff1d(liste, liste_complementaire) #element du sous domaine pas dans (element du sous domaine pas dans linterface)
		#print 'liste_noeud_interface_sdm' ,liste_noeud_interface_sdm
	
	
	
	#print" 'AEG', AEG
	return CE,bE,liste,AEG,MSE,liste_neuds_total,liste_noeud_interface_sdm
...
def EtapeDD6_a_recup_VE(liste,liste_noeud_interface_sdm):
	...
	for i in r_[0:len(liste_noeud_interface_sdm)]:
		...
		#print 'VE3' , VE3[0:3]
		VE[position_corp_dans_sdm*idof:(position_corp_dans_sdm+1)*idof]=VE3[0:3]
		#print 'VE' , VE[position_corp_dans_sdm*idof:(position_corp_dans_sdm+1)*idof]
...
for time_step in r_[1:max_time_step]:
	...
	CE,bE,liste,AEG,MSE,liste_neuds_total,liste_noeud_interface_sdm = EtapeDD3_mise_en_donnee_du_sdm(myrank,file1)
	stopCPU,stopHM = TimingStop()
	...
	for iteration_step in r_[1:max_iteration_step]:
		...
		startCPU,startHM = TimingStart()
		VE=EtapeDD6_a_recup_VE(liste,liste_noeud_interface_sdm)
		stopCPU,stopHM = TimingStop()
